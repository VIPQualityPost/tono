...
Simulate lateral (friction) force signals from topography data, modeling how the local surface slope affects the cantilever torsion signal in contact-mode AFM.
...
- This node uses a contact-mechanics formulation for topography-induced friction artifacts.
