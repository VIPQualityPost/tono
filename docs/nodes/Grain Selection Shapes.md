...
- Circumscribed circles are computed over the convex hull of each grain's pixel corners, using a centroid start plus a greedy 12Direction refinement, so the circle is the smallest enclosing circle of the grain corners.
