...
- Both input fields should be windowed before processing; the windowing control applies the Welch (default), Hann, Hamming or Blackman window otherwise used implicitly by Gwyddion's FFT based methods.
